...
Коли ви перевіряєте базу даних, ваш список міток також перебудовується.
Коли ви видаляєте окремі колоди чи карти, Anki не оновлює список використаних міток,
оскільки це неефективно. Якщо ви хочете очистити зі списку старі мітки, які більше не
...
і не перебудовує список міток під час автоматичної оптимізації.
