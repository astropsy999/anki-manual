...
Ви також можете використовувати умовну заміну, щоб контролювати, які картки генеруються. Це працює, оскільки Anki не буде генерувати картки з порожньою передньою стороною. Наприклад, розглянемо картку з двома полями на лицьовій стороні:

    {{Expression}}
    {{Notes}}

Зазвичай картку було б створено, якщо поле виразу або приміток містить текст. Якщо ви хочете, щоб картка згенерувалася, якщо вираз не був порожнім, ви можете змінити шаблон на такий:
